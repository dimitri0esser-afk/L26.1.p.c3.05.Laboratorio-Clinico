...
export default class Cl_cUsuario {
  ...
  private datosPaciente: any = null;
  private estudiosSeleccionados: any[] = [];

  constructor(vista: I_vUsuario) {
    this.vista = vista;
  ...
  private async guardarDatosPaciente() {
